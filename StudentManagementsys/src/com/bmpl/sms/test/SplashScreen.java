...
//		String image;
//		try {
//			image = ipicker.pickImage();
//		System.out.println(image);
//		wall.setIcon(new ImageIcon(SplashScreen.class.getResource(image)));
...
//		uploadImage();
		...
		JLabel wall = new JLabel("");
		wall.setIcon(new ImageIcon(SplashScreen.class.getResource("/images/img5.jpeg")));
