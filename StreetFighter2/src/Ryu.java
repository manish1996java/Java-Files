...
public class Ryu extends Sprite implements GameConstant,PlayerStates {
	...
	public void loadWalk() {
		walk[0]=image.getSubimage(1937,1657,2003-1937,1752-1657);
		walk[1]=image.getSubimage(2015,1655,2083-2015,1753-1655);
     	walk[2]=image.getSubimage(2094,1657,2163-2094,1753-1657);
		walk[3]=image.getSubimage(2175,1657,2242-2175,1753-1657);
		walk[4]=image.getSubimage(2253,1653,2319-2253,1754-1653);
		walk[5]=image.getSubimage(2329,1652,2396-2329,1754-1652);
	...
	public void powerBoard(Graphics g)
	{
		...
		g.fillRect(120,45,450,40);
	}
	
	public void power(Graphics g)
	{
		g.setColor(Color.RED);
		g.fillRect(130,50,430,30);
	}
