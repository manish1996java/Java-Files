...
//	String LOGIN_QUARY = "select userid,password,checkfirstlogin from user_mst where userid = ? and password = ?;";
	...
	String LOGIN_QUARY = "select user_mst.userid,user_mst.password,role_mst.rolename,"
			+ "right_mst.rightname,right_mst.screen,user_mst.checkfirstlogin,user_mst.status from user_mst,role_mst,right_mst,"
			...
			+ "= role_right_mapping.rightid and user_mst.status = 'y' and userid = ? and password = ? ;";
